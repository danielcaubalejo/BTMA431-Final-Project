...
## How do streaming service change TV industries?
## (What is the impact on Cable TV, news, Daily Shows, etc.)



## How has the number of people that use cable TV changed over time? How has broadcasting network revenue changed?
